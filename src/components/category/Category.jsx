            ...
            <div className="container-fluid p-0">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title">Bảng Danh Mục Sản Phẩm</h3>
                  <nav className="navbar navbar-expand-lg bg-light">
                    <div className="container-fluid">
                      <span className="navbar-brand" >
                        <button onClick={() => setIsOpen(true)} class="btn btn-success"> + Thêm mới danh mục</button>
      <ReactModal 
    isOpen={isOpen} 
...
>
    <h2 className="modal-title">Thêm Mới Danh Mục</h2>
    <form action="">
                  ...
                  >
                    ...
                    <tbody id="categories">
                      <tr>
                          ...
                          <td>hoạt động</td>
                          <td>
                              <button type="button" class="btn btn-warning">Sửa tên Danh Mục</button>
                          </td>
                          <td>
                              <button type="button" class="btn btn-danger">Sửa Trạng Thái</button>
                          </td>
                      </tr> 
